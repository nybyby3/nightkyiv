...
cats:{concerts:"Концерти",culture:"Культура",nightlife:"Нічне життя",gastro:"Гастрономія",sports:"Спорт",cinema:"Кіно",entertainment:"Розваги",cooking:"Готуємо вдома",health:"Здоров'я і Саморозвиток",home:"Домашній дозвілля"},
...
const MOOD_CATS={active:["sports","health","culture","entertainment","nightlife","gastro","cinema"],calm:["health","culture","entertainment","cooking","home","cinema"]};
