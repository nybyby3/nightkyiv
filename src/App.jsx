...
const hobbyResults=useMemo(()=>{if(!cat||!HOBBY_DATA[cat])return[];if(subcat&&HOBBY_DATA[cat][subcat])return HOBBY_DATA[cat][subcat];return Object.values(HOBBY_DATA[cat]).flat();},[cat,subcat]);;
