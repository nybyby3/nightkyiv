...
const HOBBY_DATA={"sports":{"Єдиноборства":["Бокс","Кикбоксинг","Тхэквондо","Каратэ","Дзюдо","Борьба","Фехтование","Капоэйра","Айкидо","Ушу","Кунг-фу","Самбо","Муай-тай","ММА"],"Командні види":["Футбол","Баскетбол","Волейбол","Хоккей","Водное поло","Крикет","Регби","Американский футбол","Бейсбол","Софтбол","Гандбол","Лакросс","Алтимат фрисби"],"Ракеткові":["Теннис","Настольный теннис","Бадминтон","Сквош","Падел"],"Водні види":["Плавание","Синхронное плавание","Дайвинг","Гребля","Каноэ","Каякинг","Вейкбординг","Водные лыжи","Парусный спорт"],"Зимові види":["Сноубординг","Горные лыжи","Беговые лыжи","Биатлон","Кёрлинг","Фигурное катание","Конькобежный спорт"],"Силові та фітнес":["Кроссфит","Тяжёлая атлетика","Армрестлинг","Пауэрлифтинг","Бодибилдинг","Стритлифтинг","Воркаут","Гимнастика","Акробатика"],"Екстремальні":["Скалолазание","Альпинизм","Паркур","Скейтбординг","Роликовые коньки","BMX","Мотокросс","Автоспорт","Слэклайн","Дрифт","Стант-райдинг","Даунхилл","Эндуро"],"Легка атлетика":["Бег","Марафонский бег","Спортивная ходьба","Триатлон","Лёгкая атлетика","Велоспорт","Прыжки с трамплина"],"Природа та туризм":["Пешие походы","Трекинг","Кемпинг","Глэмпинг","Бушкрафт","Ориентирование","Рыбалка","Нахлыстовая рыбалка","Подлёдная рыбалка","Спорт. рыбалка","Охота","Бёрдвотчинг","Наблюдение за звёздами","Астрономия","Фотоохота","Сбор грибов","Сбор ягод","Сбор трав","Гербарий","Пикники","Катание на лошадях","Собачьи упряжки","Джиппинг","Квадроциклы","Снегоходы","Пляжный отдых"],"Інші":["Гольф","Стрельба из лука","Верховая езда","Поло"]},"health":{"Все":["Йога","Пилатес","Танцевальный фитнес","Аквааэробика","Степ-аэробика","Стрейчинг","Цигун","Тай-чи","Изучение языков","Медитация","Волонтёрство","Благотворительность","Благотв. мероприятия"]},"entertainment":{"Все":["Петанк","Боулинг","Дартс","Фрисби","Картинг","Батут","Битбокс","Покер","Зиплайн","Банджи-джампинг","Квесты","Пейнтбол","Лазертаг","Страйкбол","Винные дегустации","Мастер-классы","Импровизационные шоу","Клубы наст. игр","Ярмарки и фестивали","Косплей-конвенты","Флешмобы","Урбанэксплоринг"]},"home":{"Творчість":["Рисование","Лепка","Шитьё","Вязание спицами","Вязание крючком","Вышивка","Вышивка крестиком","Макраме","Квилтинг","Пэчворк","Скрапбукинг","Декупаж","Мыловарение","Свечи","Ювелирное дело","Кожевенное дело","Работа с деревом","Керамика","Витражи","Роспись по стеклу","Оригами","Каллиграфия"],"Музика":["Гитара","Укулеле","Пианино","Скрипка","Барабаны","Флейта","Саксофон","Диджеинг"],"Наст. ігри":["Шахматы","Шашки","Го","Нарды","Маджонг"],"Відеоігри":["PC-гейминг","Консольный гейминг","Ретро-гейминг","VR-гейминг"],"Садівництво":["Комнатные растения","Огород на балконе","Огород","Тепличное хоз.","Ландшафтный дизайн","Флористика","Бонсай","Суккуленты","Орхидеи","Травы","Розарий","Пруд","Вертикальное озеленение","Аквариумистика","Террариумы","Палюдариумы","Микрозелень","Гидропоника","Компостирование"]},"culture":{"Музика":["Посещение концертов","Опера","Джаз-клубы","Хоровое пение","Акапелла","Написание песен","Музыкальная продукция","Битмейкинг","Этническая музыка","Классическая музыка","Электронная музыка","Рок","Фолк"],"Танці":["Бальные танцы","Латиноамериканские","Современный танец","Хип-хоп","Брейк-данс","Народные танцы","Фламенко","Танго","Свинг"],"Подорожі":["Культурный туризм","Гастротуризм","Экотуризм","Фототуризм","Автопутешествия","Автостоп"],"Творчість":["Фотография","Живопись","Граффити","Стрит-арт"],"Театр та кіно":["Театральные постановки","Стендап","Кинопроизводство","Документальное кино"],"Інше":["Литературные клубы","Тимбилдинг"]},"nightlife":{"Все":["Клубные вечеринки","Бар-хоппинг","Караоке","Стендап-вечера","Поэтические слэмы"]},"cooking":{"Все":["Выпечка хлеба","Кондитерское дело","Домашнее пивоварение","Виноделие","Самогоноварение","Ферментация","Сыроделие","Копчение","Гриль и BBQ","Кулинарные курсы","Экзотическая кухня","Молекулярная кухня","Суши и японская","Итальянская кухня","Французская кухня","Азиатская кухня","Веганская кухня","Сыроедение","Десерты","Шоколад","Кофе","Чайная церемония","Коктейли","Заготовки","Соусы","Специи","Декор блюд","Фуд-стайлинг","Фуд-фотография"]}};
