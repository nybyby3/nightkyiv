...
cats:{concerts:"Concerts",culture:"Culture",nightlife:"Nightlife",gastro:"Gastronomy",sports:"Sports",cinema:"Cinema",entertainment:"Entertainment",cooking:"Cook at Home",charity:"Charity",health:"Health & Self-dev",home:"Home Leisure"},
...
cats:{concerts:"Концерти",culture:"Культура",nightlife:"Нічне життя",gastro:"Гастрономія",sports:"Спорт",cinema:"Кіно",entertainment:"Розваги",cooking:"Готуємо вдома",charity:"Благодійність",health:"Здоров'я і Саморозвиток",home:"Домашнє дозвілля"},
...
const IC={concerts:"🎵",culture:"🎨",nightlife:"🌙",gastro:"🍽️",sports:"⚽",cinema:"🎬",entertainment:"🎮",cooking:"🍳",charity:"🤝",health:"🧘",home:"🏠"};
const CC={concerts:"#ff6bca",culture:"#3ecf8e",nightlife:"#a259ff",gastro:"#ff6b6b",sports:"#4fc3f7",cinema:"#f7b731",entertainment:"#ff9f43",cooking:"#ff8a50",charity:"#10b981",health:"#66bb6a",home:"#ab47bc"};
...
const HOBBY_DATA={"sports":{"Єдиноборства":["Бокс","Кикбоксинг","Тхэквондо","Каратэ","Дзюдо","Борьба","Фехтование","Капоэйра","Айкидо","Ушу","Кунг-фу","Самбо","Муай-тай","ММА"],"Командні види":["Футбол","Баскетбол","Волейбол","Хоккей","Водное поло","Бейсбол","Софтбол","Гандбол","Алтимат фрисби","Регби"],"Ракеткові":["Теннис","Настольный теннис","Бадминтон","Сквош","Падел"],"Водні види":["Плавание","Дайвинг","Гребля","Каноэ","Каякинг","Вейкбординг","Водные лыжи","Парусный спорт"],"Зимові види":["Фигурное катание","Горные лыжи","Сноубординг"],"Силові та фітнес":["Тяжёлая атлетика","Армрестлинг","Пауэрлифтинг","Бодибилдинг","Стритлифтинг","Воркаут","Гимнастика","Акробатика","Йога","Пилатес","Танцевальный фитнес","Аквааэробика","Степ-аэробика","Стрейчинг","Цигун","Тай-чи","Кроссфит"],"Екстремальні":["Скалолазание","Паркур","Скейтбординг","Роликовые коньки","BMX","Слэклайн","Даунхилл"],"Легка атлетика":["Бег","Марафонский бег","Спортивная ходьба","Лёгкая атлетика","Велоспорт","Прыжки с трамплина"],"Природа та туризм":["Пешие походы","Трекинг","Кемпинг","Глэмпинг","Бушкрафт","Ориентирование","Рыбалка","Нахлыстовая рыбалка","Подлёдная рыбалка","Спорт. рыбалка","Охота","Бёрдвотчинг","Наблюдение за звёздами","Астрономия","Фотоохота","Сбор грибов","Сбор ягод","Сбор трав","Пикники","Катание на лошадях","Пляжный отдых","Верховая езда","Стрельба из лука","Гольф","Поло"],"Мотоспорт":["Мотокросс","Автоспорт","Дрифт","Стант-райдинг","Эндуро","Квадроциклы","Джиппинг","Снегоходы","Картинг"]},"health":{"Все":["Изучение языков","Медитация"]},"entertainment":{"Все":["Боулинг","Дартс","Фрисби","Батут","Битбокс","Покер","Зиплайн","Банджи-джампинг","Квесты","Пейнтбол","Лазертаг","Страйкбол","Винные дегустации","Мастер-классы","Импровизационные шоу","Клубы наст. игр","Ярмарки и фестивали","Косплей-конвенты","Флешмобы","Урбанэксплоринг","Шахматы","PC-гейминг","Консольный гейминг","Ретро-гейминг","VR-гейминг"]},"home":{"Творчість":["Рисование","Лепка","Шитьё","Вязание спицами","Вязание крючком","Вышивка","Вышивка крестиком","Макраме","Квилтинг","Пэчворк","Скрапбукинг","Декупаж","Мыловарение","Свечи","Ювелирное дело","Кожевенное дело","Работа с деревом","Керамика","Витражи","Роспись по стеклу","Оригами","Каллиграфия"],"Музика":["Гитара","Укулеле","Пианино","Скрипка","Барабаны","Флейта","Саксофон","Диджеинг"],"Садівництво":["Комнатные растения","Огород на балконе","Огород","Тепличное хоз.","Ландшафтный дизайн","Флористика","Бонсай","Суккуленты","Орхидеи","Травы","Розарий","Пруд","Вертикальное озеленение","Аквариумистика","Террариумы","Палюдариумы","Микрозелень","Гидропоника","Компостирование"],"Саморозвиток":[]},"culture":{"Музика":["Посещение концертов","Опера","Джаз-клубы","Хоровое пение","Акапелла","Написание песен","Музыкальная продукция","Битмейкинг","Этническая музыка","Классическая музыка","Электронная музыка","Рок","Фолк"],"Танці":["Бальные танцы","Латиноамериканские","Современный танец","Хип-хоп","Брейк-данс","Народные танцы","Фламенко","Танго","Свинг"],"Подорожі":["Культурный туризм","Гастротуризм","Экотуризм","Фототуризм","Автопутешествия"],"Творчість":["Фотография","Живопись","Граффити","Стрит-арт"],"Театр та кіно":["Театральные постановки","Стендап","Кинопроизводство","Документальное кино"],"Інше":["Литературные клубы","Тимбилдинг"]},"nightlife":{"Все":["Клубные вечеринки","Бар-хоппинг","Караоке","Стендап-вечера","Поэтические слэмы"]},"cooking":{"Все":["Выпечка хлеба","Кондитерское дело","Домашнее пивоварение","Виноделие","Самогоноварение","Ферментация","Сыроделие","Копчение","Гриль и BBQ","Кулинарные курсы","Экзотическая кухня","Молекулярная кухня","Суши и японская","Итальянская кухня","Французская кухня","Азиатская кухня","Веганская кухня","Сыроедение","Десерты","Шоколад","Кофе","Чайная церемония","Коктейли","Заготовки","Соусы","Специи","Декор блюд","Фуд-стайлинг","Фуд-фотография"]},"charity":{"Все":["Волонтёрство","Благотворительность","Благотв. мероприятия"]}};
...
const avCats=useMemo(()=>{const counts={};allVenues.forEach(v=>{const k=CAT_REMAP[v.c]||v.c;if(cc[k])counts[k]=(counts[k]||0)+1;});Object.keys(HOBBY_DATA).forEach(k=>{if(!counts[k])counts[k]=0;counts[k]+=Object.values(HOBBY_DATA[k]).reduce((a,b)=>a+b.length,0);});return counts;},[allVenues,grp,tempo]);
...
const results=useMemo(()=>{let filtered=allVenues.filter(v=>true&&(CAT_REMAP[v.c]||v.c)===cat);if(subcat){if(sc[cat]&&sc[cat][subcat]){filtered=filtered.filter(v=>v.s===subcat);}else if(HOBBY_DATA[cat]&&HOBBY_DATA[cat][subcat]){filtered=[];}}return filtered.sort((a,b)=>{if(sortBy==="dist"&&userLoc){var da=hav(userLoc[0],userLoc[1],a.lat,a.lng),db=hav(userLoc[0],userLoc[1],b.lat,b.lng);return(da-db)*dir;}if(sortBy==="price")return(a.p-b.p)*dir;return a[lang].localeCompare(b[lang])*dir;});},[allVenues,grp,tempo,cat,subcat,sortBy,dir,lang,sc,userLoc])
const hobbyResults=useMemo(()=>{if(!cat||!HOBBY_DATA[cat])return[];if(subcat)return HOBBY_DATA[cat][subcat]||[];return Object.values(HOBBY_DATA[cat]).flat();},[cat,subcat]);;
