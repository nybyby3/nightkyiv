...
const HOBBY_DATA={
  "⚽ Спорт":{
    "Єдиноборства":["Бокс","Кикбоксинг","Тхэквондо","Каратэ","Дзюдо","Борьба","Фехтование","Капоэйра","Айкидо","Ушу","Кунг-фу","Самбо","Муай-тай","ММА"],
    "Командні види":["Футбол","Баскетбол","Волейбол","Хоккей","Водное поло","Бейсбол","Софтбол","Гандбол","Алтимат фрисби","Регби"],
    "Ракеткові":["Теннис","Настольный теннис","Бадминтон","Сквош","Падел"],
    "Водні види":["Плавание","Дайвинг","Гребля","Каноэ","Каякинг","Вейкбординг","Водные лыжи","Парусный спорт"],
    "Зимові види":["Фигурное катание","Горные лыжи","Сноубординг"],
    "Силові та фітнес":["Тяжёлая атлетика","Армрестлинг","Пауэрлифтинг","Бодибилдинг","Стритлифтинг","Воркаут","Гимнастика","Акробатика","Йога","Пилатес","Танцевальный фитнес","Аквааэробика","Степ-аэробика","Стрейчинг","Цигун","Тай-чи","Кроссфит"],
    "Екстремальні":["Скалолазание","Паркур","Скейтбординг","Роликовые коньки","BMX","Слэклайн","Даунхилл"],
    "Легка атлетика":["Бег","Марафонский бег","Спортивная ходьба","Лёгкая атлетика","Велоспорт","Прыжки с трамплина"],
    "Природа та туризм":["Пешие походы","Трекинг","Кемпинг","Глэмпинг","Бушкрафт","Ориентирование","Рыбалка","Нахлыстовая рыбалка","Подлёдная рыбалка","Спорт. рыбалка","Охота","Бёрдвотчинг","Наблюдение за звёздами","Астрономия","Фотоохота","Сбор грибов","Сбор ягод","Сбор трав","Пикники","Катание на лошадях","Пляжный отдых","Верховая езда","Стрельба из лука","Гольф","Поло"],
    "Мотоспорт":["Мотокросс","Автоспорт","Дрифт","Стант-райдинг","Эндуро","Квадроциклы","Джиппинг","Снегоходы","Картинг"]
  },
  "🧘 Здоров'я і Саморозвиток":{
    "Все":["Изучение языков","Медитация"]
  },
  "🎮 Розваги":{
    "Все":["Боулинг","Дартс","Фрисби","Батут","Битбокс","Покер","Зиплайн","Банджи-джампинг","Квесты","Пейнтбол","Лазертаг","Страйкбол","Винные дегустации","Мастер-классы","Импровизационные шоу","Клубы наст. игр","Ярмарки и фестивали","Косплей-конвенты","Флешмобы","Урбанэксплоринг","Шахматы","PC-гейминг","Консольный гейминг","Ретро-гейминг","VR-гейминг"]
  },
  "🏠 Домашнє дозвілля":{
    "Творчість":["Рисование","Лепка","Шитьё","Вязание спицами","Вязание крючком","Вышивка","Вышивка крестиком","Макраме","Квилтинг","Пэчворк","Скрапбукинг","Декупаж","Мыловарение","Свечи","Ювелирное дело","Кожевенное дело","Работа с деревом","Керамика","Витражи","Роспись по стеклу","Оригами","Каллиграфия"],
    "Музика":["Гитара","Укулеле","Пианино","Скрипка","Барабаны","Флейта","Саксофон","Диджеинг"],
    "Садівництво":["Комнатные растения","Огород на балконе","Огород","Тепличное хоз.","Ландшафтный дизайн","Флористика","Бонсай","Суккуленты","Орхидеи","Травы","Розарий","Пруд","Вертикальное озеленение","Аквариумистика","Террариумы","Палюдариумы","Микрозелень","Гидропоника","Компостирование"],
    "Саморозвиток":[]
  },
  "🎨 Культура":{
    "Музика":["Посещение концертов","Опера","Джаз-клубы","Хоровое пение","Акапелла","Написание песен","Музыкальная продукция","Битмейкинг","Этническая музыка","Классическая музыка","Электронная музыка","Рок","Фолк"],
    "Танці":["Бальные танцы","Латиноамериканские","Современный танец","Хип-хоп","Брейк-данс","Народные танцы","Фламенко","Танго","Свинг"],
    "Подорожі":["Культурный туризм","Гастротуризм","Экотуризм","Фототуризм","Автопутешествия"],
    "Творчість":["Фотография","Живопись","Граффити","Стрит-арт"],
    "Театр та кіно":["Театральные постановки","Стендап","Кинопроизводство","Документальное кино"],
    "Інше":["Литературные клубы","Тимбилдинг"]
  },
  "🌙 Нічне життя":{
    "Все":["Клубные вечеринки","Бар-хоппинг","Караоке","Стендап-вечера","Поэтические слэмы"]
  },
  "🍳 Готуємо вдома":{
    "Все":["Выпечка хлеба","Кондитерское дело","Домашнее пивоварение","Виноделие","Самогоноварение","Ферментация","Сыроделие","Копчение","Гриль и BBQ","Кулинарные курсы","Экзотическая кухня","Молекулярная кухня","Суши и японская","Итальянская кухня","Французская кухня","Азиатская кухня","Веганская кухня","Сыроедение","Десерты","Шоколад","Кофе","Чайная церемония","Коктейли","Заготовки","Соусы","Специи","Декор блюд","Фуд-стайлинг","Фуд-фотография"]
  },
  "🤝 Благодійність":{
    "Все":["Волонтёрство","Благотворительность","Благотв. мероприятия"]
  }
};
