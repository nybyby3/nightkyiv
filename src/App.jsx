...
<p style={{color:"#b0b0b0",fontSize:13,marginBottom:18,textAlign:"center"}}>{loading?("⏳ "+(lang==="en"?"Loading live showtimes...":"Завантаження актуальних сеансів...")):(liveMovies?(lang==="en"?"Live showtimes from multiplex.ua":"Сеанси з multiplex.ua в реальному часі"):(lang==="en"?"Showtimes from multiplex.ua":"Сеанси з multiplex.ua"))}</p>
...
<a href={mv.url} target="_blank" rel="noopener noreferrer" style={{display:"inline-block",marginTop:8,fontSize:12,color:"#ffd700",textDecoration:"underline"}}>{lang==="en"?"Buy tickets on multiplex.ua":"Квитки на multiplex.ua"}</a>
</div>:null}
</div>)})}
</div>);}
